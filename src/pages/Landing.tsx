...
const features = [
  {
    ...
    description: "Assign, monitor, and complete tasks with clear deadlines and accountability."
  },
  {
    icon: TrendingUp,
    title: "Weekly Performance Monitoring",
    description: "Track employee progress with weekly KPI scores and trend analysis."
  },
  {
    icon: BarChart3,
    title: "Productivity Analytics",
    description: "Visualize performance data with clear, actionable charts and reports."
  },
  {
    icon: Gift,
    title: "Bonus Reward System",
    description: "Announce bonus opportunities and reward outstanding performance transparently."
  }
];
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-12 flex items-center justify-center gap-8 text-sm text-muted-foreground font-body">
            <span className="flex items-center gap-1.5">
              <CheckCircle size={16} className="text-data-green" /> Role-based access
            </span>
            <span className="flex items-center gap-1.5">
              <CheckCircle size={16} className="text-data-green" /> Real-time analytics
            </span>
            <span className="flex items-center gap-1.5">
              <CheckCircle size={16} className="text-data-green" /> Bonus management
            </span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {features.map((feature) => (
              <div key={feature.title} className="kpi-card">
      ...
      <section id="about" className="py-20 px-6 lg:px-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground font-body leading-relaxed">
            ...
            Designed for Super Admins, Admins (HR), and Users alike - each role sees exactly
            what they need, nothing more. Performance data is presented as a natural rhythm, not
            a stressful judgment.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <div>
            ...
            <p className="text-xs text-muted-foreground font-body mt-1">
              © 2026 PerfTrack. All rights reserved.
            </p>
          </div>
