  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <KpiCard title="Total Employees" value={employees.length} icon={Users} trend="+2 this month" />
        <KpiCard title="Active Tasks" value={tasks.filter((t) => t.status !== "Completed").length} icon={ClipboardList} />
        <KpiCard title="Avg Performance" value={`${avgKpi}%`} icon={TrendingUp} trend="+5% vs last week" />
